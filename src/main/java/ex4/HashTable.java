...
public class HashTable {
     ...
     */
    public void put(/*String*/Object key, /*String*/Object value) {
     ...
     */
    public /*String*/Object get(/*String*/Object key) {
        int hash = getHash(key);
        if(entries[hash] != null) {
            HashEntry temp = MetodoGet(key, hash);
    ...
    private HashEntry MetodoGet(/*String*/Object key, int hash) {
        HashEntry temp = entries[hash];
     ...
     * @param key La clau de l'element a trobar.
     */
    public void drop(/*String*/Object key) {
        int hash = getHash(key);
        if(entries[hash] != null) {
            ...
            if(temp.prev == null && temp.key.equals(key)) {
                ...
                temp = temp.next;
                entries[hash] = temp;             //esborrar element únic (no col·lissió)
            }
            else if(temp.next != null) {
                temp.next.prev = temp.prev;   //esborrem temp, per tant actualitzem l'anterior al següent
                temp.prev.next = temp.next;                         //esborrem temp, per tant actualitzem el següent de l'anterior
            } else if (temp.next == null && temp.key.equals(key)){
                temp.prev.next = temp.next;
            }
        }
    }

    private int getHash(/*String*/Object key) {
    ...
    private class HashEntry {
        ...
        public HashEntry(/*String*/Object key, /*String*/Object value) {
            this.key = key;
            this.value = value;
            this.next = null;
            this.prev = null;
